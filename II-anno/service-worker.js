const CACHE='manuale-vivo-storia-ii-v2';
const SHELL=['./','./index.html','./styles/app.css','./scripts/app.js','./scripts/db.js','./data/manuale-part-1.js','./data/manuale-part-2.js','./data/manuale-part-3.js','./data/manuale-part-4.js','./manifest.webmanifest','./assets/icon.svg'];
